...
export function ClickerCore({
  ...
  return (
    <div className="relative mx-auto flex w-full max-w-[310px] justify-center py-1 sm:py-2">
      <motion.div
      ...
      <motion.button
        type="button"
        className="factory-button relative grid aspect-square w-[min(58vw,248px)] place-items-center rounded-full border-[7px] border-white bg-gradient-to-b from-amber-200 via-amber-300 to-amber-400 text-center shadow-[0_14px_0_#c98508,0_24px_34px_rgba(180,83,9,0.24)] outline-none disabled:cursor-not-allowed disabled:grayscale"
        disabled={isPaused}
        onClick={handleClick}
